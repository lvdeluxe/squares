...
rem
rem  Copyright 2009-2012 Adobe Systems Incorporated
...
rem
rem fontswf.bat script to launch fontswf-cli.jar in Windows Command Prompt.
rem On OSX, Unix, or Cygwin, use the fontswf shell script instead.
rem
...
@java -Dsun.io.useCanonCaches=false -Xms32m -Xmx512m -Dflexlib="%AIR_SDK_HOME%\frameworks" -jar "%AIR_SDK_HOME%\lib\fontswf-cli.jar" %*
