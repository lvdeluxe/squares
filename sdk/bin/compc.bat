...
rem
rem compc.bat script to launch compc-cli.jar in Windows Command Prompt.
...
@java -Dsun.io.useCanonCaches=false -Xms32m -Xmx512m -Dflexlib="%AIR_SDK_HOME%/frameworks" -jar "%AIR_SDK_HOME%\lib\compc-cli.jar" %*
