...
public class HDGestureParticles extends BaseGestureParticles{
	public function HDGestureParticles(p_node:GNode) {
		super(p_node);
		...
		dispersionXVariance = 16;
		dispersionYVariance = 16;
		initialScale = 1;
		endScale = 1;
