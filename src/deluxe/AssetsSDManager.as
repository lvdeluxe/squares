...
public class AssetsSDManager {

	//FONTS
	[Embed(source="/assets/ui/fonts/sd/kubus_12.png")]
	private static var KubusScoreAtlas:Class;
	[Embed(source="/assets/ui/fonts/sd/kubus_12.xml", mimeType="application/octet-stream")]
	private static var KubusScoreXML:Class;
	[Embed(source="/assets/ui/fonts/sd/kubus_24.png")]
	private static var Kubus24Atlas:Class;
	[Embed(source="/assets/ui/fonts/sd/kubus_24.xml", mimeType="application/octet-stream")]
	private static var Kubus24XML:Class;
	[Embed(source="/assets/ui/fonts/sd/kubus_72.png")]
	private static var KubusTitleAtlas:Class;
	[Embed(source="/assets/ui/fonts/sd/kubus_72.xml", mimeType="application/octet-stream")]
	private static var KubusTitleXML:Class;
	[Embed(source="/assets/ui/fonts/sd/kubus_36_stroke.png")]
	private static var KubusStrokeAtlas:Class;
	[Embed(source="/assets/ui/fonts/sd/kubus_36_stroke.xml", mimeType="application/octet-stream")]
	private static var KubusStrokeXML:Class;
	[Embed(source="/assets/ui/fonts/sd/kubus_36.png")]
	private static var KubusAtlas:Class;
	[Embed(source="/assets/ui/fonts/sd/kubus_36.xml", mimeType="application/octet-stream")]
	private static var KubusXML:Class;
	//TUTORIAL
	[Embed(source="/assets/ui/sd/tutorial_hand.png")]
	private static var TutorialHand:Class;
	[Embed(source="/assets/ui/sd/tutorial_target.png")]
	private static var TutorialTarget:Class;
	//UI
	[Embed(source="/assets/ui/sd/btn_background.png")]
	private static var ButtonBackground:Class;
	[Embed(source="/assets/ui/sd/btn_background_large.png")]
	private static var ButtonBackgroundLarge:Class;
	[Embed(source="/assets/ui/sd/checkbox.jpg")]
	private static var CheckBox:Class;
	[Embed(source="/assets/ui/sd/checkmark.png")]
	private static var CheckMark:Class;
	[Embed(source="/assets/ui/sd/header_en.png")]
	private static var HeaderEnglish:Class;
	[Embed(source="/assets/ui/sd/header_fr.png")]
	private static var HeaderFrench:Class;
	[Embed(source="/assets/ui/sd/logo.png")]
	private static var Logo:Class;
	[Embed(source="/assets/ui/sd/level_btn_bg.png")]
	private static var LevelButton:Class;
	[Embed(source="/assets/ui/sd/level_btn_bg_locked.png")]
	private static var LevelButtonLocked:Class;
	[Embed(source="/assets/ui/sd/pause_btn.png")]
	private static var PauseButton:Class;
	[Embed(source="/assets/ui/sd/popup_bg_corner.jpg")]
	private static var PopupBackgroundCorner:Class;
	[Embed(source="/assets/ui/sd/popup_bg_side.jpg")]
	private static var PopupBackgroundSide:Class;
	[Embed(source="/assets/gesture/sd/circle04.jpg")]
	private static var CircleGesture:Class;
	[Embed(source="/assets/particles/sd/particle2.png")]
	private static var Particle:Class;
	[Embed(source="/assets/particles/sd/bonus_particle.png")]
	private static var BonusParticle:Class;
	[Embed(source="/assets/ui/sd/splash.jpg")]
	public static var Splash:Class;

	public static var SquareTexture:GTexture;

	public function AssetsSDManager() {
		GameData.RESOLUTION_FACTOR = 1;
		//FONTS
		...
		var logo:GTexture = GTextureFactory.createFromEmbedded("logo",Logo);
		logo.g2d_filteringType = GTextureFilteringType.LINEAR;
